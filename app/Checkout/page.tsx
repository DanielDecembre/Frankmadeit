  ...
  return (
    <div className="outer-container">
      <div className="logo-images">
        ...
        <div className="tab2">
          <a
            href="mailto:danieldecembre15@gmail.com"
            onClick={() => (window.location.href = 'mailto:danieldecembre15@gmail.com')}
          >
            Contact Us
          </a>
        </div>
              ...
              <div className="buttons">
                <button
                  ...
                  onClick={() => {
                    ...
                    window.location.href = '/store'; // Example: redirect to store
                  }}
                >
                  Buy Now
                </button>
